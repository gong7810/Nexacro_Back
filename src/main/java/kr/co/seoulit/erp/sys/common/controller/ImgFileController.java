package kr.co.seoulit.erp.sys.common.controller;
...
import kr.co.seoulit.erp.sys.common.util.FileUploadUtil;
...
public class ImgFileController{
	...
	public String printPartInfo(HttpServletRequest request, String contentType)
	  ...
	  try { 
		  ...
		  EmployeeEntity admin = humanResourceService.findImage(EMP_CODE); //db 연동
