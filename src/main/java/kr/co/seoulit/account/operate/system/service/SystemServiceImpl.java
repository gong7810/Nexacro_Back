...
import kr.co.seoulit.account.operate.system.MapStruct.BoardReqMapStruct;
import kr.co.seoulit.account.operate.system.MapStruct.BoardResMapStruct;
import kr.co.seoulit.account.operate.system.entity.BoardEntity;
import kr.co.seoulit.account.operate.system.mapper.*;
...
public class SystemServiceImpl implements SystemService {
	...
	private final AuthorityEmpMapper authorityEmpDAO;
	...
	public SystemServiceImpl(AccountSubjectMapper accountDAO,
							 ...
							 AuthorityEmpMapper authorityEmpDAO,
	...
	public List<BoardEntity> constBoardList()throws Exception{
	...
	@Override
	public void registerBoard(BoardReqDto boardReqDto) throws Exception{
	...
	public List<BoardResDto> findBoardList()throws Exception{
		...
		List<BoardEntity> boardEntityList = boardDao.selectBoardList();
	...
	@Override
	public BoardResDto findBoardDetail(String bno)throws Exception{

	BoardEntity boardEntity	=boardDao.selectBoardDetail(bno);
	...
	@Override
	public void modifyBoard(BoardReqDto boardReqDto)throws Exception {
	...
	@Override
	public void removeBoard(String bno) throws Exception{
